...
const bookingController = {
    ...
    async submitBooking() {
        ...
        try {
            ...
            // Disable beforeunload warning now that booking is complete
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Funnel: booking_abandon + warn user before losing draft
    window.addEventListener('beforeunload', (e) => {
      ...
      if (ctrl.step && ctrl.step < 3 && ctrl.packageData) {
        ...
        // Warn user — browser shows its own generic message
        e.preventDefault();
        e.returnValue = '';
      }
    });
