...
async function loadPackages() {
    ...
    try {
        ...
        // Show cap notice if results hit the limit
        const capNotice = document.getElementById('packagesCap');
        if (capNotice) capNotice.style.display = data.length === 50 ? 'block' : 'none';
